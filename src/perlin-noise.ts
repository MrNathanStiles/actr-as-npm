...
// this was ported to Assembly Script from https://github.com/mikolalysenko/mikolalysenko.github.com/blob/master/Isosurface/js/perlinnoise.js
...
function grad(hash: u8, x: f32, y: f32, z: f32): f32 {
...
export class PerlinNoise {
    ...
    public generate(x: f32, y: f32, z: f32): f32 {
        var X: i32 = (i32)(Math.floor(x)) & 255,                  // FIND UNIT CUBE THAT
            Y: i32 = (i32)(Math.floor(y)) & 255,                  // CONTAINS POINT.
            Z: i32 = (i32)(Math.floor(z)) & 255;
    
        x -= (f32)(Math.floor(x));                                // FIND RELATIVE X,Y,Z
        y -= (f32)(Math.floor(y));                                // OF POINT IN CUBE.
        z -= (f32)(Math.floor(z));
